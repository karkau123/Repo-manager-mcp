    ...
    inputSchema: {
      ...
      properties: {
        name: {
          type: "string",
          description:
            "Repository name (spaces will be replaced with hyphens; e.g. 'testing mcp server' -> 'testing-mcp-server')",
        },
        description: {
          type: "string",
        ...
        auto_init: {
          type: "boolean",
          description: "Create initial commit with README (default: false)",
          default: false,
        },
      },
      required: ["name"],
